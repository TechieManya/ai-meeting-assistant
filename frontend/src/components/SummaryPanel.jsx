...
import { FileText, ListChecks, CheckSquare, Square, RefreshCw, Sparkles } from "lucide-react";
...
function SummaryPanel({ summary, summaryLoading, onGenerate }) {
        ...
        >
          <button
            ...
            style={{
              ...
              border: "1px solid #e2e8f0",
              backgroundColor: "#ffffff",
              color: summaryLoading ? "#94a3b8" : "#0f172a",
              fontSize: "13px",
              fontWeight: "600",
